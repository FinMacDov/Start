...
!----------------------------------------------------------------------------
pw(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nw)=zero
...
call initonegrid_usr(ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixMlo1,ixMlo2,ixMhi1,ixMhi2,&
...
do iigrid=1,igridstail; igrid=igrids(iigrid);
   saveigrid=igrid
   call initonegrid_usr(ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixMlo1,ixMlo2,ixMhi1,&
      ixMhi2,pw(igrid)%w,px(igrid)%x)
end do
