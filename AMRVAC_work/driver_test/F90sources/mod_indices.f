...
module mod_indices
  ...
  integer, save :: ixMlo1,ixMlo2,ixMhi1,ixMhi2

  integer, dimension(nlevelshi), save :: ng1,ng2
  double precision, dimension(nlevelshi), save :: dg1,dg2
  ...
  integer, save :: log_fh
  integer, save :: type_block, type_coarse_block, type_sub_block(2,2)
