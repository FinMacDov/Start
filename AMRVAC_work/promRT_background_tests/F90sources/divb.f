...
!=============================================================================
subroutine addsource_glm1(qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
...
! Psi = Psi - qdt Ch2/Cp2,Ch2/Cp2 Psi
if (eqpar(Cr_) < zero) then
  w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,psi_) = abs(eqpar(Cr_))&
     *wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,psi_)
else 
  ! implicit update of psi variable
  w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,psi_) = dexp(-qdt*(cmax_global&
     /eqpar(Cr_)))*wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,psi_)
end if
...
do idims=1,ndim
   ...
   case("central")
      call gradient(wCT(ixImin1:ixImax1,ixImin2:ixImax2,psi_),ixImin1,ixImin2,&
         ixImax1,ixImax2,ixOmin1,ixOmin2,ixOmax1,ixOmax2,idims,gradPsi)
   case("limited")
...
! e  = e  -qdt (b . grad(Psi))
   w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,e_) = w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
      e_)&
        -qdt*wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,b0_+idims)&
           *gradPsi(ixOmin1:ixOmax1,ixOmin2:ixOmax2)
...
if(fixsmall) call smallvalues(w,x,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,&
   ixOmin2,ixOmax1,ixOmax2,"addsource_glm")

end subroutine addsource_glm1
!=============================================================================
subroutine addsource_glm2(qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
   ixOmax1,ixOmax2,iwmin,iwmax,qtC,wCT,qt,w,x,dx1,dx2)
...
! Psi=Psi - qdt (v . grad(Psi))
   w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,psi_) = w(ixOmin1:ixOmax1,&
      ixOmin2:ixOmax2,psi_)&
                   -qdt*wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,m0_&
                      +idims)/wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,rho_)&
                      *gradPsi(ixOmin1:ixOmax1,ixOmin2:ixOmax2)
...
! since this option changes energy: smallvalues call
if(fixsmall) call smallvalues(w,x,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,&
   ixOmin2,ixOmax1,ixOmax2,"addsource_glm2")

end subroutine addsource_glm2
!=============================================================================
subroutine addsource_glm3(qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
   ixOmax1,ixOmax2,iwmin,iwmax,qtC,wCT,qt,w,x,dx1,dx2)
...
if (eqpar(Cr_) < zero) then
  ...
  ! implicit update of psi variable
  w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,psi_) = dexp(-qdt*(cmax_global&
     /eqpar(Cr_)))*w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,psi_)
end if
