...
INTEGER,PARAMETER:: grav0_=neqpar, grav^D_=grav0_+^D, &
                    ...
                    BB1_=nxmodes_+1,BB2_=BB1_+1,BB3_=BB2_+1, nspecialpar=^ND+5
{^IFTWOD
CHARACTER*21,PARAMETER:: specialparname='g1 g2 eps nxm bb1 bb2 bb3'
}
{^IFTHREED
CHARACTER*24,PARAMETER:: specialparname='g1 g2 g3 eps nxm bb1 bb2 bb3 '
}
...
COMMON, double precision :: SRadius,dr,gzone,rho0,Tch,Tco,bsca,htra1,htra2,htra3, &
                            ybot,ytop,Tpromax,Tpromin,pwidth,Tcoext,J_sp
