...
do idims= idimmin,idimmax
   ...
   do iw=1,nwflux
     if(any(patchf(ixCmin1:ixCmax1,ixCmin2:ixCmax2)/= 2).or.(logiB&
        .and.(iw==b0_+idims))) call getfluxforhllc(wLC,xi,ixGlo1,ixGlo2,&
        ixGhi1,ixGhi2,ixCmin1,ixCmin2,ixCmax1,ixCmax2,iw,idims,fLC,transport)
     if(any(patchf(ixCmin1:ixCmax1,ixCmin2:ixCmax2)/=-2).or.(logiB&
        .and.(iw==b0_+idims))) call getfluxforhllc(wRC,xi,ixGlo1,ixGlo2,&
        ixGhi1,ixGhi2,ixCmin1,ixCmin2,ixCmax1,ixCmax2,iw,idims,fRC,transport)
     if (transport) then
       if(any(patchf(ixCmin1:ixCmax1,ixCmin2:ixCmax2)/= 2).or.(logiB&
          .and.(iw==b0_+idims))) fLC(ixCmin1:ixCmax1,ixCmin2:ixCmax2,iw)&
          =fLC(ixCmin1:ixCmax1,ixCmin2:ixCmax2,iw)+vLC(ixCmin1:ixCmax1,&
          ixCmin2:ixCmax2)*wLC(ixCmin1:ixCmax1,ixCmin2:ixCmax2,iw)
       if(any(patchf(ixCmin1:ixCmax1,ixCmin2:ixCmax2)/=-2).or.(logiB&
          .and.(iw==b0_+idims))) fRC(ixCmin1:ixCmax1,ixCmin2:ixCmax2,iw)&
