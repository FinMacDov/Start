...
!-----------------------------------------------------------------------------
   ...
   do i1=-1,1
      if (i1==0.and.i2==0) then 
         if (isafety(igrid,mype) > nsafety) neighbor_active(i1,i2,igrid) &
            = .false.
      end if
...
!-----------------------------------------------------------------------------
      ixOmin1=ixGlo1+dixB;ixOmin2=ixGlo2+dixB;ixOmax1=ixGhi1-dixB
      ixOmax2=ixGhi2-dixB;

      igrid_active = -1      
      
      call flag_grid_usr(t,ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixOmin1,ixOmin2,&
         ixOmax1,ixOmax2,pw(igrid)%w,px(igrid)%x,igrid_active)
