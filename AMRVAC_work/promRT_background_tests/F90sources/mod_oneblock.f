...
xd1 = (xloc(1)-xoneblock(ic11,ic12,1)) / (xoneblock(ic21,ic12,1) &
   - xoneblock(ic11,ic12,1))      
xd2 = (xloc(2)-xoneblock(ic11,ic12,2)) / (xoneblock(ic11,ic22,2) &
   - xoneblock(ic11,ic12,2))
