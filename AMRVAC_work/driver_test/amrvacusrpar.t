...
COMMON, double precision :: pa(jmax),Tea(jmax),rhoa(jmax),ya(jmax),mua(jmax), pigl(jmax)
COMMON, double precision :: Lunit,Teunit,nHunit,runit,Bunit,mHunit, &
                            k_B,miu0,vunit,tunit,punit,heatunit,R_gas,m_p
COMMON, double precision :: dr,Ti,J_sp,J_d,iniene
