...
print *, eqpar(grav2_), -0.20205992101732712*(vunit**2/Lunit)
...
if(iprob==-1)then
  ...
  primnames= TRIM(primnames)//' '//'T beta test rho_test TEunit T_getTherm beta_getTherm p_getTherm'
  wnames=TRIM(wnames)//' '//'T beta test rho_test TEunit T_getTherm beta_getTherm p_getTherm'
endif
