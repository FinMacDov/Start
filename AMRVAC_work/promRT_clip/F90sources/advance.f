...
!$OMP PARALLEL DO PRIVATE(igrid)
  do iigrid=1,igridstail; igrid=igrids(iigrid);
     pwres(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)=pw(igrid)%w&
        (ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)
  end do
!$OMP END PARALLEL DO
endif
...
if(ssplitdust .or. ssplitdivb .or. ssplitresis .or. ssplituser) call &
   addsource_all(.true.)
...
!$OMP PARALLEL DO PRIVATE(igrid)
do iigrid=1,igridstail; igrid=igrids(iigrid);
   pwold(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux+nwaux)&
      =pw(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux+nwaux)
end do
!$OMP END PARALLEL DO
...
!$OMP PARALLEL DO PRIVATE(igrid)
  do iigrid=1,igridstail; igrid=igrids(iigrid);
     pwres(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)= &
        pw(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)-pwres(igrid)%w&
        (ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)
  end do
!$OMP END PARALLEL DO
endif
...
!$OMP PARALLEL DO PRIVATE(igrid)
do iigrid=1,igridstail; igrid=igrids(iigrid);
   allocate (pw1(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nw))
...
case ("onestep")
   call advect1(typefull1,one,    idimmin,idimmax,t,          pw1,t,pw, pwold)
case ("twostep")
   ! predictor step
   call advect1(typepred1,half,   idimmin,idimmax,t,          pw, t,pw1,pwold)
   ! corrector step
   call advect1(typefull1,one,    idimmin,idimmax,t+half*dt,  pw1,t,pw, pwold)
case ("threestep")
   ! three step Runge-Kutta in accordance with Gottlieb & Shu 1998
   call advect1(typefull1,one, idimmin,idimmax,t,          pw ,t,pw1,pwold)

   do iigrid=1,igridstail; igrid=igrids(iigrid);
      allocate (pw2(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nw))
      pw2(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)=0.75d0&
         *pw(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)&
         +0.25d0*pw1(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)
      if (nw>nwflux) pw2(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,nwflux&
         +1:nw) = pw(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,nwflux+1:nw)
   end do

   call advect1(typefull1,0.25d0, idimmin,idimmax,t+dt,pw1,t&
      +dt*0.25d0,pw2,pwold)

!$OMP PARALLEL DO PRIVATE(igrid)
   do iigrid=1,igridstail_active; igrid=igrids_active(iigrid);
      pw(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)=1.0d0&
         /3.0d0*pw(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)&
         +2.0d0/3.0d0*pw2(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)
   end do   
!$OMP END PARALLEL DO
   call advect1(typefull1,2.0d0/3.0d0, idimmin,idimmax,t+dt/2.0d0,pw2,t&
      +dt/3.0d0,pw,pwold)
...
! === First step ===
   call advect1(typefull1,0.5d0, idimmin,idimmax,t,          pw ,t,pw1,pwold)

! === Second step ===
   do iigrid=1,igridstail; igrid=igrids(iigrid);
      allocate (pw2(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nw))
      pw2(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)=pw1(igrid)%w&
         (ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)
      if (nw>nwflux) pw2(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,nwflux&
         +1:nw) = pw(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,nwflux+1:nw)
   end do
   call advect1(typefull1,0.5d0, idimmin,idimmax,t,pw1,t+dt,pw2,pwold)

! === Third step ===
   do iigrid=1,igridstail; igrid=igrids(iigrid);
      allocate (pw3(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nw))
      pw3(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)=2.0d0&
         /3.0d0 * pw(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux) &
         + 1.0d0/3.0d0 * pw2(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)
      if (nw>nwflux) pw3(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,nwflux&
         +1:nw) = pw(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,nwflux+1:nw)
   end do
   call advect1(typefull1,1.0d0/6.0d0, idimmin,idimmax,t,pw2,t+dt,pw3,pwold)

! === Fourth step ===
!$OMP PARALLEL DO PRIVATE(igrid)
   do iigrid=1,igridstail_active; igrid=igrids_active(iigrid);
      pw(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)=pw3(igrid)%w&
         (ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)
   end do   
!$OMP END PARALLEL DO
   call advect1(typefull1,0.5d0, idimmin,idimmax, t,pw3, t+dt,pw, pwold)
...
! === First step ===
   call advect1(typefull1,0.391752226571890d0, idimmin,idimmax, t,pw ,t,pw1,&
       pwold)

! === Second step ===
   do iigrid=1,igridstail; igrid=igrids(iigrid);
      allocate (pw2(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nw))
      pw2(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)=0.444370493651235d0 &
         * pw(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux) &
         + 0.555629506348765d0 * pw1(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         1:nwflux)
      if (nw>nwflux) pw2(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,nwflux&
         +1:nw) = pw(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,nwflux+1:nw)
   end do
   call advect1(typefull1,0.368410593050371d0, idimmin,idimmax, t&
      +0.391752226571890d0*dt,pw1, t+0.2176690962611688d0*dt,pw2, pwold)

! === Third step ===
   do iigrid=1,igridstail; igrid=igrids(iigrid);
      allocate (pw3(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nw))
      pw3(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)=0.620101851488403d0 &
         * pw(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux) &
         + 0.379898148511597d0 * pw2(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         1:nwflux)
      if (nw>nwflux) pw3(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,nwflux&
         +1:nw) = pw(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,nwflux+1:nw)
   end do
   call advect1(typefull1,0.251891774271694d0, idimmin,idimmax, t&
      +0.5860796893115398d0*dt,pw2, t+0.222650588849706d0*dt,pw3, pwold)

! === Fourth step ===
   do iigrid=1,igridstail; igrid=igrids(iigrid);
      allocate (pw4(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nw))
      pw4(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)=0.178079954393132d0 &
         * pw(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux) &
         + 0.821920045606868d0 * pw3(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         1:nwflux)
      if (nw>nwflux) pw4(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,nwflux&
         +1:nw) = pw(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,nwflux+1:nw)
   end do
   call advect1(typefull1,0.544974750228521d0, idimmin,idimmax, t&
      +0.4745423631214d0*dt,pw3, t+0.390035880739132d0*dt,pw4, pwold)
! Now recover back the dt*L(u3), store in pw1:
!$OMP PARALLEL DO PRIVATE(igrid)
   do iigrid=1,igridstail; igrid=igrids(iigrid);
      pw1(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux) = ( &
         pw4(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux) &
         - (0.178079954393132d0 * pw(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         1:nwflux) + 0.821920045606868d0 * pw3(igrid)%w(ixGlo1:ixGhi1,&
         ixGlo2:ixGhi2,1:nwflux)) ) / 0.544974750228521d0
   end do
!$OMP END PARALLEL DO
...
!$OMP PARALLEL DO PRIVATE(igrid)
   do iigrid=1,igridstail; igrid=igrids(iigrid);
      pw(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)= 0.517231671970585d0 &
         * pw2(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux) &
         + 0.096059710526147d0 * pw3(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         1:nwflux) + 0.063692468666290d0 * pw1(igrid)%w(ixGlo1:ixGhi1,&
         ixGlo2:ixGhi2,1:nwflux) + 0.386708617503269d0 * pw4(igrid)%w&
         (ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)
   end do
!$OMP END PARALLEL DO
   call advect1(typefull1,0.226007483236906d0, idimmin,idimmax, t&
      +0.935010630967653d0*dt,pw4, t+0.710300048096804d0*dt,pw, pwold)
...
case ("rk4")
   ...
   do iigrid=1,igridstail; igrid=igrids(iigrid);
      allocate (pw2(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nw))
      pw2(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)=pw(igrid)%w&
         (ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)
   end do
   call advect1(typefull1,0.5d0, idimmin,idimmax,t+dt/2d0,   pw1,t,pw2,pwold)
   do iigrid=1,igridstail; igrid=igrids(iigrid);
      allocate (pw3(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nw))
      pw3(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)=pw(igrid)%w&
         (ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)
   end do
   call advect1(typefull1,one,   idimmin,idimmax,t+dt/2d0,   pw2,t,pw3,pwold)
!$OMP PARALLEL DO PRIVATE(igrid)
   do iigrid=1,igridstail; igrid=igrids(iigrid);
      pw1(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)=(pw1(igrid)%w&
         (ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux) +two*pw2(igrid)%w&
         (ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux) +pw3(igrid)%w(ixGlo1:ixGhi1,&
         ixGlo2:ixGhi2,1:nwflux) -4.0d0*pw(igrid)%w(ixGlo1:ixGhi1,&
         ixGlo2:ixGhi2,1:nwflux))/3.0d0
   end do
!$OMP END PARALLEL DO
   call advect1(typefull1,1.0d0/6.0d0, idimmin,idimmax,t+dt,  pw3,t,pw,pwold)
!$OMP PARALLEL DO PRIVATE(igrid)
   do iigrid=1,igridstail; igrid=igrids(iigrid);
      pw(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)=pw1(igrid)%w&
         (ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)+pw(igrid)%w(ixGlo1:ixGhi1,&
         ixGlo2:ixGhi2,1:nwflux)
   end do
!$OMP END PARALLEL DO
case ("fourstep")
   ! four step scheme, variant Hans De Sterck
   call advect1(typefull1,0.12d0, idimmin,idimmax,t,          pw ,t,pw1,pwold)
   do iigrid=1,igridstail; igrid=igrids(iigrid);
      allocate (pw2(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nw))
      pw2(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)=pw(igrid)%w&
         (ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)
   end do
   call advect1(typefull1,0.25d0, idimmin,idimmax,t+dt*0.12d0,pw1,t,pw2,pwold)
!$OMP PARALLEL DO PRIVATE(igrid)
   do iigrid=1,igridstail; igrid=igrids(iigrid);
      pw1(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)=pw(igrid)%w&
         (ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)
   end do
!$OMP END PARALLEL DO
   call advect1(typefull1,0.5d0,  idimmin,idimmax,t+dt/4d0   ,pw2,t,pw1,pwold)
   call advect1(typefull1,one,    idimmin,idimmax,t+dt/2d0   ,pw1,t,pw, pwold)
case ("jameson")
   ! four step scheme, variant jameson
   call advect1(typefull1,0.25d0, idimmin,idimmax,t,          pw ,t,pw1,pwold)
   do iigrid=1,igridstail; igrid=igrids(iigrid);
      allocate (pw2(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nw))
      pw2(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)=pw(igrid)%w&
         (ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)
   end do
   call advect1(typefull1,(1.0d0/3.0d0), idimmin,idimmax,t+dt&
      *0.25d0,pw1,t,pw2,pwold)
!$OMP PARALLEL DO PRIVATE(igrid)
   do iigrid=1,igridstail; igrid=igrids(iigrid);
      pw1(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)=pw(igrid)%w&
         (ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)
...
!$OMP END PARALLEL DO
   call advect1(typefull1,0.5d0,  idimmin,idimmax,t+dt/3d0   ,pw2,t,pw1,pwold)
   call advect1(typefull1,one,    idimmin,idimmax,t+dt/2d0   ,pw1,t,pw, pwold)
case default
...
!=============================================================================
subroutine advect1(method,dtfactor,idimmin,idimmax,qtC,pwa,qt,pwb,pwc)
...
if (time_advance.and.levmax>levmin) then
   if (istep==nstep.or.nstep>2) call init_comm_fix_conserve(idimmin,idimmax)
end if
...
do iigrid=1,igridstail_active; igrid=igrids_active(iigrid);
   ...
   call process1_grid(method(level),igrid,qdt,ixGlo1,ixGlo2,ixGhi1,ixGhi2,&
      idimmin,idimmax,qtC,pwa(igrid)%w,qt,pwb(igrid)%w,pwc(igrid)%w)
...
if (time_advance.and.levmax>levmin) then
   if (istep==nstep.or.nstep>2) then
      do iigrid=1,igridstail; igrid=igrids(iigrid);
         call sendflux(igrid,idimmin,idimmax)
      end do
      call fix_conserve(pwb,idimmin,idimmax)
   end if
end if
...
call getbc(qt+qdt,qdt,ixGlo1,ixGlo2,ixGhi1,ixGhi2,pwb,pwCoarse,pgeo,&
   pgeoCoarse,.false.,0,nwflux+nwaux)
...
integer, intent(in) :: igrid, ixGmin1,ixGmin2,ixGmax1,ixGmax2, idimmin,idimmax
...
call advect1_grid(method,qdt,ixGmin1,ixGmin2,ixGmax1,ixGmax2,idimmin,idimmax,&
   qtC,wCT,qt,w,wold,fC,dx1,dx2, px(igrid)%x)
...
if (time_advance.and.levmax>levmin) then
   if (istep==nstep.or.nstep>2) call storeflux(igrid,fC,idimmin,idimmax)
end if
...
ixOmin1=ixImin1+dixB;ixOmin2=ixImin2+dixB;ixOmax1=ixImax1-dixB
ixOmax2=ixImax2-dixB;

select case (method)
case ('cd')
   call centdiff(qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,ixOmax1,&
      ixOmax2,idimmin,idimmax,qtC,wCT,qt,w,fC,dx1,dx2,x)
case ('cd4')
...
case ('hancock')
   call hancock(qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,ixOmax1,&
      ixOmax2,idimmin,idimmax,qtC,wCT,qt,w,dx1,dx2,x)
case ('fd')
   call fd(method,qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,ixOmax1,&
      ixOmax2,idimmin,idimmax,qtC,wCT,qt,w,wold,fC,dx1,dx2,x)
case ('tvdmu','tvdmu1')
   call tvdmusclf(method,qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
      ixOmax1,ixOmax2,idimmin,idimmax,qtC,wCT,qt,w,wold,fC,dx1,dx2,x)
case ('tvdlf','tvdlf1')
   call tvdlf(method,qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
      ixOmax1,ixOmax2,idimmin,idimmax,qtC,wCT,qt,w,wold,fC,dx1,dx2,x)
case ('hll','hll1')
   call hll(method,qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
      ixOmax1,ixOmax2,idimmin,idimmax,qtC,wCT,qt,w,wold,fC,dx1,dx2,x)
case ('hllc','hllc1', 'hllcd','hllcd1')
   call hllc(method,qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
      ixOmax1,ixOmax2,idimmin,idimmax,qtC,wCT,qt,w,wold,fC,dx1,dx2,x)

case ('hlld','hlld1', 'hlldd','hlldd1')
   call hlld(method,qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
      ixOmax1,ixOmax2,idimmin,idimmax,qtC,wCT,qt,w,wold,fC,dx1,dx2,x)
...
case ('tvd','tvd1')
   ...
   call tvdlimit(method,qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
      ixOmax1,ixOmax2,idimmin,idimmax,wCT,qt+qdt,w,fC,dx1,dx2,x)
case ('source')
...
do iigrid=1,igridstail_active; igrid=igrids_active(iigrid);
   ...
   do i1=-1,1
      ...
      if (neighbor_type(i1,i2,igrid)==2 .or. neighbor_type(i1,i2,igrid)&
         ==4) then
...
call getbc(qt,0.d0,ixGlo1,ixGlo2,ixGhi1,ixGhi2,pw,pwCoarse,pgeo,pgeoCoarse,&
...
case ('sf')
   call addsource2(qdt  ,ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixMlo1,ixMlo2,ixMhi1,&
      ixMhi2,1,nw,qt,w1,qt,w,px(igrid)%x,.true.)
case ('sfs')
...
case ('ssf')
   call addsource2(qdt/2,ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixGlo1,ixGlo2,ixGhi1,&
      ixGhi2,1,nw,qt,w,qt,w1,px(igrid)%x,.true.)
   call addsource2(qdt  ,ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixMlo1,ixMlo2,ixMhi1,&
      ixMhi2,1,nw,qt,w1,qt,w,px(igrid)%x,.true.)
case ('ssfss')
...
if(qsourcesplit .eqv. ssplituser) call specialsource(qdt,ixImin1,ixImin2,&
   ixImax1,ixImax2,ixOmin1,ixOmin2,ixOmax1,ixOmax2,iwmin,iwmax,qtC,wCT,qt,w,x)

! physics defined sources, typically explicitly added,
! along with geometrical source additions
call addsource(qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,ixOmax1,&
   ixOmax2,iwmin,iwmax,qtC,wCT,qt,w,x,qsourcesplit)
...
do iigrid=1,igridstail; igrid=igrids(iigrid);
   ...
   typelimiter=typelimiter1(node(plevel_,igrid))
   typegradlimiter=typegradlimiter1(node(plevel_,igrid))
   call process_grid_usr(igrid,level,ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixMlo1,&
      ixMlo2,ixMhi1,ixMhi2,qt,pw(igrid)%w,px(igrid)%x)
end do
!$OMP END PARALLEL DO
...
do icycle=1,ncycle
  if(sourceparasts)then
    qdt=dtimpl/(one+parastsnu+(parastsnu-one)* dcos(half*dpi*(two&
       *dble(icycle)-one)/dble(ncycle)))
  else
    qdt=dt/dble(ncycle)
  endif
!$OMP PARALLEL DO PRIVATE(igrid)
...
!$OMP END PARALLEL DO
  ...
  sumqdt=sumqdt+qdt
  qt=qt+qdt
  call getbc(qt,qdt,ixGlo1,ixGlo2,ixGhi1,ixGhi2,pw,pwCoarse,pgeo,pgeoCoarse,&
     .false.,0,nwflux+nwaux)
enddo
...
integer, intent(in) :: igrid
double precision, intent(in) :: qdt, qt, x(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:ndim)
double precision, intent(inout) :: w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,nw)
...
w1(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:nwflux)=w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
   1:nwflux)

call specialsource_impl(qdt,ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixMlo1,ixMlo2,ixMhi1,&
   ixMhi2,1,nw,qt,w1,qt,w,x)
