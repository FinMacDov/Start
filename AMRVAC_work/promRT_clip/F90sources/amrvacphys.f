...
select case (iw)
  ...
  case (tr1_)
   ...
   f(ixOmin1:ixOmax1,ixOmin2:ixOmax2,iw)=w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
      psi_)
         transport=.false.
      else
         f(ixOmin1:ixOmax1,ixOmin2:ixOmax2,iw)= -w(ixOmin1:ixOmax1,&
...
!f_i[psi]=Ch2*b_i,!f_i[psi]=Ch2*b_i,i
! Eq. 24e and Eq. 38c Dedner et al 2002 JCP, 175, 645
   case(psi_)

       f(ixOmin1:ixOmax1,ixOmin2:ixOmax2,iw)=cmax_global**2&
          *w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,b0_+idims)
...
select case (iw)
  ...
  case (tr1_)
   ...
   f(ixOmin1:ixOmax1,ixOmin2:ixOmax2)=w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,psi_)
         transport=.false.
      else
         f(ixOmin1:ixOmax1,ixOmin2:ixOmax2)= -w(ixOmin1:ixOmax1,&
            ixOmin2:ixOmax2,b0_+idims)*w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,m1_)&
...
! Eq. 24e and Eq. 38c Dedner et al 2002 JCP, 175, 645
   case(psi_)
       ...
       f(ixOmin1:ixOmax1,ixOmin2:ixOmax2)=cmax_global**2*w(ixOmin1:ixOmax1,&
...
case ('glm1')
   call addsource_glm1(qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
      ixOmax1,ixOmax2,iwmin,iwmax,qtC,wCT,qt,w,x,dx1,dx2)
case ('glm2')
   call addsource_glm2(qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
      ixOmax1,ixOmax2,iwmin,iwmax,qtC,wCT,qt,w,x,dx1,dx2) 
case ('glm3')
   call addsource_glm3(qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
      ixOmax1,ixOmax2,iwmin,iwmax,qtC,wCT,qt,w,x,dx1,dx2)
...
case ('spherical')
   ...
   do iw=1,nwflux
      ...
      ! s[b1]=2*psi/r
      case (b1_)
         tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2)=2.0d0*wCT(ixOmin1:ixOmax1,&
            ixOmin2:ixOmax2,psi_)
      ...
      ! Divide by radius and add to w
      if (iw==m1_ .or.iw==b1_.or.iw==m2_.or.iw==b2_ .or.iw==b3_ &
         .or.(iw==m3_.and..not.angmomfix)) w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         iw)=w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,iw)+qdt*tmp(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2)/x(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1)
   end do
end select
