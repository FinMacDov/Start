...
integer :: hxOmin1,hxOmin2,hxOmax1,hxOmax2, ixCmin1,ixCmin2,ixCmax1,ixCmax2,&
    jxCmin1,jxCmin2,jxCmax1,jxCmax2, jxICmin1,jxICmin2,jxICmax1,jxICmax2, iw,&
    il
!-----------------------------------------------------------------------------
...
call average(wL,wR,x,ixICmin1,ixICmin2,ixICmax1,ixICmax2,idims,wroeC,workroe)
...
do il=1,nwflux
   ...
   call geteigenjump(wL,wR,wroeC,x,ixICmin1,ixICmin2,ixICmax1,ixICmax2,il,&
      idims,smallaC,adtdxC,jumpC,workroe)
   ...
   call getphi(method,jumpC,adtdxC,smallaC,ixImin1,ixImin2,ixImax1,ixImax2,&
      ixICmin1,ixICmin2,ixICmax1,ixICmax2,ixCmin1,ixCmin2,ixCmax1,ixCmax2,il,&
      idims,phiC,dxdim)
   ...
   do iw=1,nwflux
      call rtimes(phiC,wroeC,ixCmin1,ixCmin2,ixCmax1,ixCmax2,iw,il,idims,&
         rphiC,workroe)
      ...
      fC(ixCmin1:ixCmax1,ixCmin2:ixCmax2,iw,idims)=fC(ixCmin1:ixCmax1,&
         ixCmin2:ixCmax2,iw,idims)+rphiC(ixCmin1:ixCmax1,ixCmin2:ixCmax2)

      wnew(ixOmin1:ixOmax1,ixOmin2:ixOmax2,iw)=wnew(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,iw)+rphiC(ixOmin1:ixOmax1,ixOmin2:ixOmax2)&
         -rphiC(hxOmin1:hxOmax1,hxOmin2:hxOmax2)
   end do  !iw
end do     !il

end subroutine tvdlimit2
!=============================================================================
subroutine getphi(method,jumpC,adtdxC,smallaC,ixImin1,ixImin2,ixImax1,ixImax2,&
   ixICmin1,ixICmin2,ixICmax1,ixICmax2,ixCmin1,ixCmin2,ixCmax1,ixCmax2,il,&
   idims,phiC,dxdim)
...
ixmin1=hxmin1+kr(idims,1);ixmin2=hxmin2+kr(idims,2);ixmax1=hxmax1+kr(idims,1)
ixmax2=hxmax2+kr(idims,2);

select case(typetvd)
case('roe')
   call dwlimiter2(jumpC,ixImin1,ixImin2,ixImax1,ixImax2,ixICmin1,ixICmin2,&
      ixICmax1,ixICmax2,il,idims,ljumpC,dxdim)
   ...
   if(method=='tvd')phiC(ixCmin1:ixCmax1,ixCmin2:ixCmax2)=phiC&
   ...
   if(typeentropy(il)=='nul'.or.typeentropy(il)=='ratio')then
      ...
      elsewhere
         phiC(ixCmin1:ixCmax1,ixCmin2:ixCmax2)=-phiC(ixCmin1:ixCmax1,&
            ...
            *smallaC(ixCmin1:ixCmax1,ixCmin2:ixCmax2)+half/smallaC&
            (ixCmin1:ixCmax1,ixCmin2:ixCmax2)*tmp(ixCmin1:ixCmax1,&
            ixCmin2:ixCmax2)**2)*jumpC(ixCmin1:ixCmax1,ixCmin2:ixCmax2)
      endwhere
   endif
case('harten')
   ...
   if(typeentropy(il)=='nul'.or.typeentropy(il)=='ratio')then
      ...
      elsewhere
         phiC(ixCmin1:ixCmax1,ixCmin2:ixCmax2)=-ljumpC(jxCmin1:jxCmax1,&
            jxCmin2:jxCmax2)-ljumpC(ixCmin1:ixCmax1,ixCmin2:ixCmax2)&
            +jumpC(ixCmin1:ixCmax1,ixCmin2:ixCmax2)*(half*smallaC&
            (ixCmin1:ixCmax1,ixCmin2:ixCmax2)+half/smallaC(ixCmin1:ixCmax1,&
